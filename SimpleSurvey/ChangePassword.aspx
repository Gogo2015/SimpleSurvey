...
<body>
    <form id="form1" runat="server">
        <div text-align: center style="margin-left: 480px">
            <asp:Label ID="txtTitle" runat="server" Font-Bold="True" Text="Change Password"></asp:Label>
        </div>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <br />
        <br />
        <asp:Label ID="lbCurrent" runat="server" Text="Current Password:"></asp:Label>
&nbsp;&nbsp;&nbsp;
        ...
        <br />
        <br />
        <asp:Label ID="lbNew" runat="server" Text="New Password:"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="txtNew" runat="server" Width="200px" TextMode="Password"></asp:TextBox>
        <asp:Label ID="lbErrorMsgNew" runat="server" ForeColor="#993333"></asp:Label>
        <br />
        <br />
